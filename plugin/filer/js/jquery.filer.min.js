            ...
            var l = e(n)
              ...
              , u = {
                ...
                _bindInput: function() {
                    ...
                    p.dragDrop && (o.length > 0 ? o : l).bind("drop", u._dragDrop.drop).bind("dragover", u._dragDrop.dragEnter).bind("dragleave", u._dragDrop.dragLeave),
                    p.uploadFile && p.clipBoardPaste && e(window).on("paste", u._clipboardPaste)
                },
                ...
                _changeInput: function() {
                    if (u._applyAttrSettings(),
                    null != p.beforeRender && "function" == typeof p.beforeRender ? p.beforeRender(r, l) : null,
                    p.theme && r.addClass("jFiler-theme-" + p.theme),
                    "input" != l.get(0).tagName.toLowerCase() && "file" != l.get(0).type)
                        o = l,
                    ...
                    (!p.limit || p.limit && p.limit >= 2) && (l.attr("multiple", "multiple"),
                    "[]" != l.attr("name").slice(-2) ? l.attr("name", l.attr("name") + "[]") : null),
                    u._bindInput(),
                    p.files && u._append(!1, {
                        files: p.files
                    }),
                ...
                _clear: function() {
                    ...
                    u._set("feedback", u._itFl && u._itFl.length > 0 ? u._itFl.length + " " + p.captions.feedback2 : p.captions.feedback),
                    null != p.onEmpty && "function" == typeof p.onEmpty ? p.onEmpty(r, o, l) : null
                },
                _reset: function(i) {
                    if (!i) {
                ...
                _filesCheck: function() {
                    ...
                    if (p.limit && u.files.length + u._itFl.length > p.limit)
                        return alert(u._assets.textParse(p.captions.errors.filesLimit)),
                        !1;
                    for (var t = 0; t < u.files.length; t++) {
                        ...
                        if (null != p.extensions && -1 == e.inArray(n, p.extensions))
                            return alert(u._assets.textParse(p.captions.errors.filesType, a)),
                            !1;
                        if (null != p.maxSize && u.files[t].size > 1048576 * p.maxSize)
                            return alert(u._assets.textParse(p.captions.errors.filesSize, a)),
                            !1;
                        if (4096 == l.size && 0 == l.type.length)
                            return !1;
                        i += u.files[t].size
                    }
                    if (null != p.maxSize && i >= Math.round(1048576 * p.maxSize))
                        return alert(u._assets.textParse(p.captions.errors.filesSizeAll)),
                        !1;
                ...
                _thumbCreator: {
                    create: function(i) {
                        var t = u.files[i]
                          ...
                          , c = "";
                        return t.opts && (f = e.extend({}, t.opts, f)),
                        c = e(u._thumbCreator.renderContent(f)).attr("data-jfiler-index", n),
                        c.get(0).jfiler_id = n,
                        u._thumbCreator.renderFile(t, c, f),
                        t.forList ? c : (u._itFc.html = c,
                        c.hide()[p.templates.itemAppendToEnd ? "appendTo" : "prependTo"](s.find(p.templates._selectors.list)).show(),
                    ...
                    renderFile: function(i, t, n) {
                        if (0 == t.find(".jFiler-item-thumb-image").size())
                            return !1;
                    ...
                    _box: function(i) {
                        if (null != p.beforeShow && "function" == typeof p.beforeShow ? !p.beforeShow(u.files, s, r, o, l) : !1)
                            return !1;
                        if (s.length < 1) {
                            if (p.appendTo)
                                var t = e(p.appendTo);
                ...
                _upload: function(i) {
                    var t = u._itFc.html
                      , n = new FormData;
                    if (n.append(l.attr("name"), u._itFc.file, u._itFc.file.name ? u._itFc.file.name : !1),
                ...
                _ajax: {
                    send: function(i, t, n) {
                        return n.ajax = e.ajax({
                            ...
                            complete: function(e, i) {
                                n.ajax = !1,
                                u._ajFc++,
                                u._ajFc >= u.files.length && (u._ajFc = 0,
                                null != p.uploadFile.onComplete && "function" == typeof p.uploadFile.onComplete ? p.uploadFile.onComplete(s, r, o, l, e, i) : null)
                            },
                            ...
                            success: function(e, t, a) {
                                n.uploaded = !0,
                                null != p.uploadFile.success && "function" == typeof p.uploadFile.success ? p.uploadFile.success(e, i, s, r, o, l, n.id, t, a) : null
                            },
                            error: function(e, t, a) {
                                n.uploaded = !1,
                                null != p.uploadFile.error && "function" == typeof p.uploadFile.error ? p.uploadFile.error(i, s, r, o, l, n.id, e, t, a) : null
                            },
                    ...
                    progressHandling: function(e, i) {
                        if (e.lengthComputable) {
                            ...
                            null != p.uploadFile.onProgress && "function" == typeof p.uploadFile.onProgress ? p.uploadFile.onProgress(t, i, s, r, o, l) : null,
                            i.find(".jFiler-jProgressBar").find(p.templates._selectors.progressBar).css("width", t + "%")
                        }
                    }
                },
                _dragDrop: {
                    dragEnter: function(e) {
                        ...
                        null != p.dragDrop.dragEnter && "function" == typeof p.dragDrop.dragEnter ? p.dragDrop.dragEnter(e, o, l, r) : null
                    },
                    dragLeave: function(e) {
                        return e.preventDefault(),
                        e.stopPropagation(),
                        u._dragDrop._dragLeaveCheck(e) ? (r.removeClass("dragged"),
                        u._set("feedback", p.captions.feedback),
                        void (null != p.dragDrop.dragLeave && "function" == typeof p.dragDrop.dragLeave ? p.dragDrop.dragLeave(e, o, l, r) : null)) : !1
                    },
                    drop: function(e) {
                        e.preventDefault(),
                        r.removeClass("dragged"),
                        u._set("feedback", p.captions.feedback),
                        e && e.originalEvent && e.originalEvent.dataTransfer && e.originalEvent.dataTransfer.files && e.originalEvent.dataTransfer.files.length > 0 && u._onChange(e, e.originalEvent.dataTransfer.files),
                        null != p.dragDrop.drop && "function" == typeof p.dragDrop.drop ? p.dragDrop.drop(e.originalEvent.dataTransfer.files, e, o, l, r) : null
                    },
                    _dragLeaveCheck: function(i) {
                        var t = i.relatedTarget
                          , n = !1;
                        return t !== o && (t && (n = e.contains(o, t)),
                        n) ? !1 : !0
                    }
                },
                        ...
                        var t = i ? e.originalEvent.dataTransfer.items : e.originalEvent.clipboardData.items
                          , n = function(e, i, t) {
                            ...
                            for (var n = atob(e), l = [], a = 0; a < n.length; a += t) {
                                for (var r = n.slice(a, a + t), o = new Array(r.length), s = 0; s < r.length; s++)
                                    o[s] = r.charCodeAt(s);
                ...
                _onSelect: function(i) {
                    ...
                    null != p.onSelect && "function" == typeof p.onSelect ? p.onSelect(u.files[i], u._itFc.html, s, r, o, l) : null,
                    i + 1 >= u.files.length && (null != p.afterShow && "function" == typeof p.afterShow ? p.afterShow(s, r, o, l) : null)
                },
                _onChange: function(i, t) {
                    if (t) {
                        ...
                        if (!l.get(0).files || "undefined" == typeof l.get(0).files || 0 == l.get(0).files.length)
                            return p.uploadFile || p.addMore || (u._set("input", ""),
                            u._clear()),
                            !1;
                        u.files = l.get(0).files
                    }
                    if (p.uploadFile || p.addMore || u._reset(!0),
                    l.prop("jFiler").files = u.files,
                    !u._filesCheck() || (null != p.beforeSelect && "function" == typeof p.beforeSelect ? !p.beforeSelect(u.files, s, r, o, l) : !1))
                        return u._set("input", ""),
                        u._clear(),
                        !1;
                    if (u._set("feedback", u.files.length + u._itFl.length + " " + p.captions.feedback2),
                    p.showThumbs)
                        u._thumbCreator._box();
                    else
                        for (var n = 0; n < u.files.length; n++)
                            u.files[n]._choosed = !0,
                            u._addToMemory(n),
                            u._onSelect(n);
                    if (!p.uploadFile && p.addMore) {
                ...
                _retryUpload: function(i, t) {
                    ...
                    return a.length > 0 ? !p.uploadFile || e.isEmptyObject(p.uploadFile) || a[0].uploaded ? void 0 : (u._itFc = a[0],
                    l.prop("jFiler").current_file = u._itFc,
                    u._upload(n),
                    !0) : !1
                },
                _remove: function(i, n) {
                    if (n.binded) {
                        if ("undefined" != typeof n.data.id && (n = s.find(p.templates._selectors.item + "[data-jfiler-index='" + n.data.id + "']"),
                        0 == n.size()))
                            return !1;
                    ...
                    var a = n.get(0).jfiler_id || n.attr("data-jfiler-index")
                      ...
                      , f = function(i) {
                        var n = r.find("input[name^='jfiler-items-exclude-']:hidden").first()
                          , a = u._itFl[i]
                          , o = [];
                        if (0 == n.size() && (n = e('<input type="hidden" name="jfiler-items-exclude-' + (p.excludeName ? p.excludeName : ("[]" != l.attr("name").slice(-2) ? l.attr("name") : l.attr("name").substring(0, l.attr("name").length - 2)) + "-" + t) + '">'),
                        n.appendTo(r)),
                      ...
                      , c = function(i, t) {
                        f(t),
                        u._itFl.splice(t, 1),
                        u._itFl.length < 1 ? (u._reset(),
                        u._clear()) : u._set("feedback", u._itFl.length + " " + p.captions.feedback2),
                        i.fadeOut("fast", function() {
                            e(this).remove()
                        })
                    };
                    for (var m in u._itFl)
                        "length" !== m && u._itFl.hasOwnProperty(m) && u._itFl[m].id == a && (d = m);
                    return u._itFl.hasOwnProperty(d) ? u._itFl[d].ajax ? (u._itFl[d].ajax.abort(),
                    void c(n, d)) : (null != p.onRemove && "function" == typeof p.onRemove ? p.onRemove(n, u._itFl[d].file, d, s, r, o, l) : null,
                    void c(n, d)) : !1
                },
                _addToMemory: function(i) {
                    ...
                    p.addMore && !u.files[i]._appended && (u._itFl[u._itFl.length - 1].input = l),
                ...
                _assets: {
                    ...
                    textParse: function(i, t) {
                        ...
                        }, t && e.isPlainObject(t) ? t : {}, p.options),
                        typeof i) {
                        case "string":
                            return i.replace(/\{\{fi-(.*?)\}\}/g, function(e, i) {
                                return i = i.replace(/ /g, ""),
                                i.match(/(.*?)\|limitTo\:(\d+)/) ? i.replace(/(.*?)\|limitTo\:(\d+)/, function(e, i, n) {
                                    var i = t[i] ? t[i] : ""
                                      , l = i.substring(0, n);
