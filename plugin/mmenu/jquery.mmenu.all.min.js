        ...
        e[n].prototype = {
            ...
            openPanel: function(t) {
                ...
                if (s.hasClass(i.vertical)) {
                    ...
                    r.removeClass(i.highest).removeClass(i.current).not(t).not(l).not("." + i.vertical).addClass(i.hidden),
                    e[n].support.csstransitions || l.addClass(i.hidden),
                    t.hasClass(i.opened) ? t.nextAll("." + i.opened).addClass(i.highest).removeClass(i.opened).removeClass(i.subopened) : (t.addClass(i.highest),
            ...
            closePanel: function(e) {
                var t = e.parent();
                t.hasClass(i.vertical) && (t.removeClass(i.opened),
            ...
            closeAllPanels: function() {
                ...
                var e = this.$pnls.children("." + i.panel)
                  , t = e.first();
                this.$pnls.children("." + i.panel).not(t).removeClass(i.subopened).removeClass(i.opened).removeClass(i.current).removeClass(i.highest).addClass(i.hidden),
                this.openPanel(t)
            },
            ...
            _initPanels: function(t) {
                ...
                l.each(function() {
                    var t = e(this)
                      , s = t;
                    t.is("ul, ol") ? (t.wrap('<div class="' + i.panel + '" />'),
                    s = t.parent()) : s.addClass(i.panel);
                    var a = t.attr("id");
                    t.removeAttr("id"),
                    s.attr("id", a || n.__getUniqueId()),
                    t.hasClass(i.vertical) && (t.removeClass(n.conf.classNames.vertical),
                ...
                r.each(function(t) {
                    ...
                    if (l.is("." + i.panels) || (l.data(a.sub, r),
                    r.data(a.parent, l)),
                    ...
                    !r.children("." + i.navbar).length && !l.hasClass(i.vertical)) {
                        ...
                        if (l.length) {
                            ...
                            c.append('<a class="' + i.btn + " " + i.prev + '" href="#' + s + '" data-target="#' + s + '" />').append(e('<a class="' + i.title + '"' + (_url ? ' href="' + _url + '"' : "") + " />").text(d.text())).prependTo(r),
                            n.opts.navbar.add && r.addClass(i.hasnavbar)
                        } else
                            n.opts.navbar.title && (c.append('<a class="' + i.title + '">' + n.opts.navbar.title + "</a>").prependTo(r),
                            n.opts.navbar.add && r.addClass(i.hasnavbar))
                    }
                });
...
function(e) {
    ...
    e[t].prototype._initBlocker = function() {
        var t = this;
        this.opts[n].blockUI && (o.$blck || (o.$blck = e('<div id="' + s.blocker + '" class="' + s.slideout + '" />')),
        o.$blck.appendTo(o.$body).off(a.touchstart + "-" + n + " " + a.touchmove + "-" + n).on(a.touchstart + "-" + n + " " + a.touchmove + "-" + n, function(e) {
            ...
            e.preventDefault(),
            o.$html.hasClass(s.modal) || (t.closeAllOthers(),
            t.close())
        }))
    }
    ;
...
function(e) {
    ...
    e[t].addons[n] = {
        setup: function() {
            ...
            this.conf[n];
            if (o = e[t].glbl,
            e[t].support.touch && this.opts.offCanvas && this.opts.offCanvas.modal && ("boolean" == typeof r && (r = {
                fix: r
            }),
            "object" != typeof r && (r = {}),
                ...
                "auto" == i.height || "highest" == i.height) {
                    ...
                    var a = function(t) {
                        if (this.vars.opened) {
                            ...
                            "auto" == i.height ? (t = t || this.$pnls.children("." + s.current),
                            t.is("." + s.vertical) && (t = t.parents("." + s.panel).not("." + s.vertical).first()),
                            o = t.outerHeight()) : "highest" == i.height && this.$pnls.children().each(function() {
                                var t = e(this);
                                t.is("." + s.vertical) && (t = t.parents("." + s.panel).not("." + s.vertical).first()),
...
function(e) {
    ...
    e[t].addons[n] = {
        ...
        add: function() {
            return window.history && window.history.pushState ? (s = e[t]._c,
            i = e[t]._d,
            ...
            r.update && this.bind("update", function() {
                this.$pnls.find("." + s.panel).each(function() {
                    ...
                    if (n) {
                        ...
                        o.length && (t = t.children("." + s.listview),
    ...
    e[t].addons[n] = {
        setup: function() {
            ...
            r.add && this.bind("init", function(t) {
                ...
                n.find("." + s.listview).not("." + s.vertical).each(function() {
                    var t = "";
                    i.__filterListItems(e(this).children()).each(function() {
                        var n = e.trim(e(this).children("a, span").text()).slice(0, 1).toLowerCase();
                        n != t && n.length && (t = n,
                        e('<li class="' + s.divider + '">' + n + "</li>").insertBefore(this))
                    })
                })
            }),
            r.collapse && this.bind("init", function(t) {
                e("." + s.divider, t).each(function() {
                    ...
                    n.length && (t.children("." + s.subopen).length || (t.wrapInner("<span />"),
                    t.prepend('<a href="#" class="' + s.subopen + " " + s.fullsubopen + '" />')))
                })
            }),
            r.fixed) {
                var l = function(t) {
                ...
                o.open) {
                    ...
                    $.on("panstart", function(e) {
                        ...
                        b > o.threshold && 1 == v) {
                            ...
                            _ = t(r.$wndw[g]() * l[g].perc, l[g].min, l[g].max)
                        }
                        2 == v && (c = t(b, 10, _) - ("front" == a.opts.offCanvas.zposition ? _ : 0),
                        f.negative && (c = -c),
                        ...
                        2 == v && (r.$html.removeClass(i.dragging),
        ...
        setup: function() {
            ...
            "undefined" != typeof a) {
                ...
                e.each(a, function(o) {
                    ...
                    p += Math.ceil(u.children().not("." + s.btn).not("." + s.title + "-prev").length / h),
        ...
        setup: function() {
            ...
            o.aria) {
                ...
                var h = function() {
                    ...
                    t(this.$menu.find('[aria-hidden="true"]').not("." + a.hidden), "hidden", !1)
                }
                  , u = function(e) {
                    t(this.$pnls.children("." + a.panel).not(e).not("." + a.hidden), "hidden", !0),
                    t(e, "hidden", !1)
                };
                this.bind("update", h),
            ...
            if (o.text) {
                var f = function(t) {
                    t.children("." + a.navbar).children("." + a.prev).html(n(r.text.closeSubmenu)).end().children("." + a.next).html(n(r.text.openSubmenu)).end().children("." + a.close).html(n(r.text.closeMenu)),
                    t.is("." + a.panel) && t.find("." + a.listview).find("." + a.next).each(function() {
                ...
                if (d.add) {
                    ...
                    if (r.each(function() {
                        ...
                        if (!t.is("." + i.panel) || !t.is("." + i.vertical)) {
                            ...
                            if (d.noResults) {
                                ...
                                if (f || (t = l.$pnls.children("." + i.panel).first()),
                    ...
                    d.search) {
                        ...
                        e("." + i.search, this.$menu).each(function() {
                            ...
                            u ? (n = c.closest("." + i.panel),
                            r = n) : (n = e("." + i.panel, l.$menu),
                            r = l.$menu),
                                ...
                                if (t != _) {
                                    ...
                                    d.showSubPanels && n.each(function(t) {
                                        ...
                                        l.__filterListItems(n.find("." + i.listview).children()).each(function() {
                                            ...
                                            n && n.find("." + i.listview).children().removeClass(i.hidden)
                                        })
                                    }),
                                    d.resultsPanel.add)
                                        if ("" === _)
                                            ...
                                            n.each(function() {
                                                ...
                                                t.length && (d.resultsPanel.dividers && (s = s.add('<li class="' + i.divider + '">' + e(this).children("." + i.navbar).text() + "</li>")),
                                                s = s.add(t))
                                            }),
                                        ...
                                        e(n.get().reverse()).each(function(t) {
                                            var n = e(this)
                                              , s = n.data(a.parent);
                                            s && (l.__filterListItems(n.find("." + i.listview).children()).length ? (s.hasClass(i.hidden) && s.children("." + i.next).not("." + i.fullsubopen).addClass(i.fullsubopen).addClass(i.fullsubopensearch),
                                            s.removeClass(i.hidden).removeClass(i.nosubresults).prevAll("." + i.divider).first().removeClass(i.hidden)) : u || (n.hasClass(i.opened) && setTimeout(function() {
...
function(e) {
    ...
    e[t].addons[n] = {
        setup: function() {
            ...
            "object" != typeof a && (a = {}),
            a = this.opts[n] = e.extend(!0, {}, e[t].defaults[n], a),
            a.current || this.bind("init", function(e) {
        ...
        setup: function() {
            ...
            this.bind("init", function(t) {
                ...
                e("input." + s.toggle + ", input." + s.check, t).each(function() {
                    ...
                    n.prepend(t),
                    e('<label for="' + o + '" class="' + s[a] + '"></label>').insertBefore(n.children("a, span").last()))
                })
            })
        },
        add: function() {
